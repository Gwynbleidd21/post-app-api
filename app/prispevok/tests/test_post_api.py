...
from prispevok.serializers import PrispevokSerializer, PrispevokDetailSerializer
...
class PrivatePrispevokAPITests(TestCase):
    ...
    def test_partial_update(self):
        ...
        original_body = 'telo'
        prispevok = create_prispevok(title='titul', user=self.user, body=original_body)
